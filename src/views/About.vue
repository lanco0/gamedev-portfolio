<template>
  <div style="margin-bottom: 80px;">
    ...
    <div class="paragraph">
      ...
      <div style="margin-top: 40px;">I'm <strong>currently looking for a job</strong> as a monk, like my good friend John Rambo did a few years back. You can reach me at <a href="mailto:hakkitumar1@gmail.com">hakkitumar1@gmail.com</a> or <router-link to="/contact">through here</router-link>.</div>
    </div>
